    ...
    def probabilisticModel(self, msg):
        ...
        for i, _ in enumerate(err):
            ...
            if w < self.w1:
                ...
                err[i] = 2*self.accuracy_blowout_k*self.accuracy[i]*np.random.rand()-self.accuracy_blowout_k*self.accuracy[i]
            else:
                err[i] = 2*self.acuuracy_max_blowout_k*self.accuracy[i]*np.random.rand()-self.acuuracy_max_blowout_k*self.accuracy[i]
